...
public class SortingUtilTest {
    ...
    public void bubbleSortNullTest() {
        Exception ex = null;
        try {
            SortingUtil sortingUtil = new SortingUtil(BubbleSortStrategy.getInstance());
            sortingUtil.sort(null);
        } catch (Exception e) {
            ex = e;
        }
    ...
    @Test
    public void bubbleSortDuplicatedValueTest() {
        int[] array1 = {2, 1, 0, 2, 8, 7, 2};
        int[] array2 = {0, 1, 2, 2, 2, 7, 8};
        SortingUtil sortingUtil = new SortingUtil(BubbleSortStrategy.getInstance());
        sortingUtil.sort(array1);
    ...
    public void quickSortNullTest() {
        Exception ex = null;
        try {
            SortingUtil sortingUtil = new SortingUtil(QuickSortStrategy.getInstance());
            sortingUtil.sort(null);
        } catch (Exception e) {
            ex = e;
        }
    ...
    @Test
    public void quickSortDuplicatedValueTest() {
        int[] array1 = {2, 1, 0, 2, 8, 7, 2};
        int[] array2 = {0, 1, 2, 2, 2, 7, 8};
        SortingUtil sortingUtil = new SortingUtil(QuickSortStrategy.getInstance());
        sortingUtil.sort(array1);
